...
<div class="modal fade" tabindex="-1" role="dialog"
    ...
    <div ref="modal" class="modal-dialog" :class="{ 'modal-sm': small, 'modal-lg': large }">
    ...
    methods: {
        ...
        setVisiblity(visible) {
            if (visible) {
                ...
                velocity(this.$refs.modal, 'slideDown', {duration: 300}).then(() => {
                ...
                velocity(this.$refs.modal, 'slideUp', {duration: 300}).then(() => {
