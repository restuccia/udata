...
<box :title="title" :icon="icon"
    ...
    <aside slot="tools">
        <div class="btn-group" v-show="downloads.length">
            ...
            <ul class="dropdown-menu" role="menu">
                <li v-for="download in downloads" :key="download.url">
    ...
    <footer slot="footer">
        <div :class="{ 'pull-right': p.pages > 1 }" ref="footer_container">
...
export default {
    ...
    computed: {
        has_footer_children() {
            return this.$refs.footer_container
                && this.$refs.footer_container.children.length;
        },
        show_footer() {
